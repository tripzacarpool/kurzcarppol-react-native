...
Write-Host 'Starting Docker infrastructure: mongo, redis, kafka'
docker compose -f (Join-Path $Root 'docker-compose.yml') up -d mongo redis kafka
...
$env:PORT = '5000'
$env:MONGODB_URI = 'mongodb://127.0.0.1:27017/tripza'
$env:MONGODB_DB = 'tripzaapp'
